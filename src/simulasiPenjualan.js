    ...
    <div className="max-w-3xl mx-auto p-6 bg-white rounded shadow space-y-6">
      ...
      <table className="w-full mt-4 border text-sm text-left">
        ...
        <tbody>
          ...
          <tr><td className="p-2 border font-semibold">Net Profit Harian</td><td className="p-2 border">Rp {formatRupiah(netProfitHarian)}</td></tr>
          <tr><td className="p-2 border font-semibold">Net Profit Bulanan</td><td className="p-2 border">Rp {formatRupiah(netProfitBulanan)}</td></tr>
          ...
          <tr className="font-bold bg-gray-50">
            <td className="p-2 border">Total ROI 6 Bulan</td><td className="p-2 border text-green-600">Rp {formatRupiah(roi6Bulan)}</td>
          </tr>
          <tr className="font-bold bg-gray-50">
            <td className="p-2 border">Total ROI 12 Bulan</td><td className="p-2 border text-green-600">Rp {formatRupiah(roi12Bulan)}</td>
          </tr>
        </tbody>
      </table>
    </div>
